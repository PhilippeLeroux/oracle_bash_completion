...
alias _reply_with_stopconcurrency_list=_reply_with_node_number_list
...
function _reply_with_empty_list
{
	COMPREPLY=()
}

#	For this options user must provide a value.
alias _reply_with_statefile_list=_reply_with_empty_list
alias _reply_with_volume_list=_reply_with_empty_list
alias _reply_with_device_list=_reply_with_empty_list
alias _reply_with_name_list=_reply_with_empty_list
alias _reply_with_id_list=_reply_with_empty_list
alias _reply_with_envs_list=_reply_with_empty_list
alias _reply_with_env_list=_reply_with_empty_list
alias _reply_with_failoverdelay_list=_reply_with_empty_list
alias _reply_with_failoverretry_list=_reply_with_empty_list
alias _reply_with_edition_list=_reply_with_empty_list
alias _reply_with_pdb_list=_reply_with_empty_list
alias _reply_with_maxlag_list=_reply_with_empty_list
alias _reply_with_sql_translation_profile_list=_reply_with_empty_list
alias _reply_with_retention_list=_reply_with_empty_list
alias _reply_with_replay_init_time_list=_reply_with_empty_list
alias _reply_with_pqservice_list=_reply_with_empty_list
alias _reply_with_pqpool_list=_reply_with_empty_list
alias _reply_with_gsmflags_list=_reply_with_empty_list
alias _reply_with_address_list=_reply_with_empty_list
alias _reply_with_subnet_list=_reply_with_empty_list
alias _reply_with_nettype_list=_reply_with_empty_list
alias _reply_with_pingtarget_list=_reply_with_empty_list
alias _reply_with_pwfile_list=_reply_with_empty_list
alias _reply_with_proxy_list=_reply_with_empty_list
alias _reply_with_timeout_list=_reply_with_empty_list
alias _reply_with_domain_list=_reply_with_empty_list
alias _reply_with_spfile_list=_reply_with_empty_list
alias _reply_with_dbname_list=_reply_with_empty_list
alias _reply_with_acfspath_list=_reply_with_empty_list
alias _reply_with_emport_list=_reply_with_empty_list
alias _reply_with_onslocalport_list=_reply_with_empty_list
alias _reply_with_onsremoteport_list=_reply_with_empty_list
alias _reply_with_remoteservers_list=_reply_with_empty_list
alias _reply_with_clientdata_list=_reply_with_empty_list
alias _reply_with_count_list=_reply_with_empty_list
alias _reply_with_endpoints_list=_reply_with_empty_list
alias _reply_with_invitednodes_list=_reply_with_empty_list
alias _reply_with_invitedsubnets_list=_reply_with_empty_list
alias _reply_with_scanname_list=_reply_with_empty_list
alias _reply_with_min_list=_reply_with_empty_list
alias _reply_with_max_list=_reply_with_empty_list
alias _reply_with_importance_list=_reply_with_empty_list
alias _reply_with_category_list=_reply_with_empty_list
alias _reply_with_storage_list=_reply_with_empty_list
alias _reply_with_network_number_list=_reply_with_empty_list
alias _reply_with_description_list=_reply_with_empty_list
alias _reply_with_path_list=_reply_with_empty_list
alias _reply_with_options_list=_reply_with_empty_list
alias _reply_with_clients_list=_reply_with_empty_list
alias _reply_with_user_list=_reply_with_empty_list
alias _reply_with_fsoptions_list=_reply_with_empty_list
alias _reply_with_appid_list=_reply_with_empty_list
alias _reply_with_auxvolumes_list=_reply_with_empty_list
alias _reply_with_checkinterval_list=_reply_with_empty_list
alias _reply_with_exportserver_list=_reply_with_empty_list
alias _reply_with_exportpath_list=_reply_with_empty_list
alias _reply_with_mountoptions_list=_reply_with_empty_list
alias _reply_with_dbtype_list=_reply_with_empty_list
...
function _reply_with_true_false_list
{
	_reply "true false"
}

alias _reply_with_notification_list=_reply_with_true_false_list
alias _reply_with_global_list=_reply_with_true_false_list
alias _reply_with_commit_outcome_list=_reply_with_true_false_list
alias _reply_with_dtp_list=_reply_with_true_false_list
